...
def show_landing_page():
    ...
    cursor2.execute("SELECT AD.ADDRESSID, A.AMENITYNAME, AL.QUANTITY from AMENITY A , AMENITIES_LIST AL, USER_LIST UL, ADDRESS AD  where A.AMENITYID=AL.AMENITYID AND AL.ADDRESSID=AD.ADDRESSID AND AL.USERID=UL.USERID AND UL.USERNAME=%s;", [username])
